    ...
    try:
        ...
        if catalog_table.database_type == DatabaseType.S3.value:
            ...
            if "DBInstances" in response and len(response["DBInstances"]) > 0:
                ...
                # instance_info struct:{'DBInstanceIdentifier': 'database-1', 'DBInstanceClass': 'db.t3.micro', 'Engine': 'mysql', 'DBInstanceStatus': 'available', 'MasterUsername': 'root', 'Endpoint': {'Address': 'database-1.cmolfojknl2e.rds.cn-northwest-1.amazonaws.com.cn', 'Port': 3306, 'HostedZoneId': 'Z1BJHPUGKGJOC5'}, 'AllocatedStorage': 20, 'InstanceCreateTime': datetime.datetime(2023, 9, 5, 5, 15, 12, 239000, tzinfo=tzutc()), 'PreferredBackupWindow': '10:48-11:18', 'BackupRetentionPeriod': 7, 'DBSecurityGroups': [], 'VpcSecurityGroups': [{'VpcSecurityGroupId': 'sg-0b7a2b704e8091280', 'Status': 'active'}], 'DBParameterGroups': [{'DBParameterGroupName': 'default.mysql8.0', 'ParameterApplyStatus': 'in-sync'}], 'AvailabilityZone': 'cn-northwest-1a', 'DBSubnetGroup': {'DBSubnetGroupName': 'default-vpc-0ace6acd199dadaa1', 'DBSubnetGroupDescription': 'Created from the RDS Management Console', 'VpcId': 'vpc-0ace6acd199dadaa1', 'SubnetGroupStatus': 'Complete', 'Subnets': [{'SubnetIdentifier': 'subnet-0c0f775e0e55387dc', 'SubnetAvailabilityZone': {'Name': 'cn-northwest-1b'}, 'SubnetOutpost': {}, 'SubnetStatus': 'Active'}, {'SubnetIdentifier': 'subnet-03e9ec5a97990d6b9', 'SubnetAvailabilityZone': {'Name': 'cn-northwest-1a'}, 'SubnetOutpost': {}, 'SubnetStatus': 'Active'}, {'SubnetIdentifier': 'subnet-0bb38ab4563591339', 'SubnetAvailabilityZone': {'Name': 'cn-northwest-1b'}, 'SubnetOutpost': {}, 'SubnetStatus': 'Active'}, {'SubnetIdentifier': 'subnet-01d2748adccf3d6c2', 'SubnetAvailabilityZone': {'Name': 'cn-northwest-1a'}, 'SubnetOutpost': {}, 'SubnetStatus': 'Active'}]}, 'PreferredMaintenanceWindow': 'wed:11:48-wed:12:18', 'PendingModifiedValues': {}, 'LatestRestorableTime': datetime.datetime(2023, 9, 27, 5, 10, tzinfo=tzutc()), 'MultiAZ': False, 'EngineVersion': '8.0.33', 'AutoMinorVersionUpgrade': True, 'ReadReplicaDBInstanceIdentifiers': [], 'LicenseModel': 'general-public-license', 'OptionGroupMemberships': [{'OptionGroupName': 'default:mysql-8-0', 'Status': 'in-sync'}], 'PubliclyAccessible': False, 'StorageType': 'gp2', 'DbInstancePort': 0, 'StorageEncrypted': True, 'KmsKeyId': 'arn:aws-cn:kms:cn-northwest-1:427492443556:key/43981aa7-0d9c-47f2-bde0-ee12ca465693', 'DbiResourceId': 'db-7SF5SBQBOGFRLCBEJCW4HS4FKQ', 'CACertificateIdentifier': 'rds-ca-rsa2048-g1', 'DomainMemberships': [], 'CopyTagsToSnapshot': True, 'MonitoringInterval': 60, 'EnhancedMonitoringResourceArn': 'arn:aws-cn:logs:cn-northwest-1:427492443556:log-group:RDSOSMetrics:log-stream:db-7SF5SBQBOGFRLCBEJCW4HS4FKQ', 'MonitoringRoleArn': 'arn:aws-cn:iam::427492443556:role/rds-monitoring-role', 'DBInstanceArn': 'arn:aws-cn:rds:cn-northwest-1:427492443556:db:database-1', 'IAMDatabaseAuthenticationEnabled': False, 'PerformanceInsightsEnabled': False, 'DeletionProtection': False, 'AssociatedRoles': [], 'MaxAllocatedStorage': 1000, 'TagList': [], 'CustomerOwnedIpEnabled': False, 'BackupTarget': 'region', 'NetworkType': 'IPV4', 'StorageThroughput': 0, 'CertificateDetails': {'CAIdentifier': 'rds-ca-rsa2048-g1', 'ValidTill': datetime.datetime(2024, 9, 5, 5, 14, 22, tzinfo=tzutc())}}
