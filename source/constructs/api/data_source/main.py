...
@inject_session
def reload_organization_account(organization_managed_account_id='', service_managed_stack_name=''):
    return service.reload_organization_account(organization_managed_account_id, service_managed_stack_name)
