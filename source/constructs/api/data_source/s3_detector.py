...
def detect(accounts):
    ...
    for aws_account_id in accounts:
        ...
        logger.info("Bucket source list")
        logger.info(s3_db_bucket_name_list)
        logger.info(s3_db_region_list)
        logger.info(s3_db_glue_state)
        logger.info(s3_agent_bucket_name_list)
        ...
        logger.info(str(deleted_s3_bucket_source_list))
        ...
        for deleted_s3_bucket_source in deleted_s3_bucket_source_list:
            ...
            logger.info(deleted_s3_region)
            logger.info(s3_connection_state)
