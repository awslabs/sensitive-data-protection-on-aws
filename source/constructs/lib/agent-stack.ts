...
export class AgentStack extends Stack {
  constructor(scope: Construct, id: string, props?: StackProps) {
    ...
    const bucketName = "sensitive-data-protection-bucket";
    ...
    const trustedRoleARN = `arn:${Aws.PARTITION}:iam::${adminAccountId.valueAsString}:role/${trustedRoleName}`;

    const disJobStateMachine = new DiscoveryJobStack(this, "DiscoveryJobStateMachine", {
      projectName: SolutionInfo.SOLUTION_NAME_ABBR,
      adminAccountId: adminAccountId.valueAsString
    });

    const crawlerEventBridge = new CrawlerEventbridgeStack(this, "CrawlerEventbridge", {
      adminAccountId: adminAccountId.valueAsString,
