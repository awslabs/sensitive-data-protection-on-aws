...
export class DeleteAgentResourcesStack extends Construct {
  constructor(scope: Construct, id: string, props: DeleteAgentResourcesProps) {
    ...
    const deleteAgentResourcesRole = new Role(this, 'DeleteAgentResourcesRole', {
      roleName: `${SolutionInfo.SOLUTION_NAME_ABBR}DeleteAgentResourcesRole-${Aws.REGION}`, //Name must be specified
    ...
    deleteAgentResourcesRole.attachInlinePolicy(new Policy(this, 'AutoSyncDataLambdaPolicy', {
      statements: [
        new PolicyStatement({
          effect: Effect.ALLOW,
          actions: [
    ...
    const deleteAgentResourcesFunction = new Function(this, 'DeleteAgentResourcesFunction', {
      functionName: `${SolutionInfo.SOLUTION_NAME_ABBR}-DeleteAgentResources`, //Name must be specified
