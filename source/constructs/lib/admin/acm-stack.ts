...
export class AcmStack extends Construct {
  ...
  constructor(scope: Construct, id: string, props: AcmProps) {
    ...
    const acmLayer = new LayerVersion(this, 'AcmLayer', {
      ...
      description: `${SolutionInfo.SOLUTION_FULL_NAME} - ACM generated by the program layer`,
    });
    ...
    const acmFunction = new Function(this, 'AcmFunction', {
      functionName: `${SolutionInfo.SOLUTION_NAME}-ACM`, //Name must be specified
      description: `${SolutionInfo.SOLUTION_FULL_NAME} - This creates a self-signed certificate used by your LoadBalancer`,
