...
const DataSourceDelete = (props: any) => {
  const {
    title,
    isShowDelete,
    setIsShowDelete,
  ...
  return (
    ...
    >
      <p className="delete-top">{t('datasource:jdbc.deleteDataSourceFromSystemTipsA')} {selectedInstances.length} {t('datasource:jdbc.deleteDataSourceFromSystemTipsB')}</p>
      {
