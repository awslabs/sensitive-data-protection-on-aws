...
| [Amazon RDS](https://aws.amazon.com/rds/) | **Supporting**. Set up, operate, and scale a relational database in the cloud with just a few clicks. |
| [Amazon SQS](https://aws.amazon.com/sqs/) | **Supporting**. Fully managed message queuing for microservices, distributed systems, and serverless applications. |
